...
">
        <div id="hero-section"
             class="gap-y-8 min-h-screen px-6 py-12  pt-28 flex flex-col justify-start w-full overflow-hidden">
            <div
                class="hidden top overflow-hidden absolute left-0  pt-28 right-[10%] top-0  h-screen lg:flex flex-col justify-start text-white py-12 z-[3] "
